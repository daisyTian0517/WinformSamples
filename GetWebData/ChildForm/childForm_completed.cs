...
namespace GetWebData
{
    public partial class childForm_completed : Form
    {
        ...
        private void btn_viewData_Click(object sender, EventArgs e)
        {
            ...
            ProcessStartInfo pcsinfo = new ProcessStartInfo(@"\\172.17.10.21\File30\Xiao Wang\Zhanglong Wu\VS&Languages\Daisy Tian\2021\MyWinfroms\GetWebData\" + GlobalData.taskArray[index1, 1] + ".csv");
        ...
        private void btn_loadData_Click(object sender, EventArgs e)
        {
            ...
            //连接数据库
            //string sql_con = "server=127.0.0.1; user=root; password=mysql; database=spiderdata; port=3306; charset=utf8;";
            ...
            mySqlDataAdapter = new SqlDataAdapter(select_sqlstr, sql_con);
