...
namespace GetWebData
{
    ...
    public partial class childForm_running : Form
    {
        ...
        private void btn_run01_Click(object sender, EventArgs e)
        {
            ...
            string DateDirectory = @"\\172.17.10.21\File30\Xiao Wang\Zhanglong Wu\VS&Languages\Daisy Tian\2021\MyWinfroms\GetWebData";
        ...
        private void CollectionData(int index, TextBox textBox, TabPage tabPage)
        {
            ...
            string savePath = @"\\172.17.10.21\File30\Xiao Wang\Zhanglong Wu\VS&Languages\Daisy Tian\2021\MyWinfroms\GetWebData\" + taskname + ".csv";
            ...
            //连接数据库
             string sql_con = @"Data Source=(localdb)\ProjectsV13;Initial Catalog=DaisyDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
             SqlConnection mySqlConnection = new SqlConnection(sql_con);
  ...
  `Web_URL` varchar(128) DEFAULT NULL COMMENT '网址'
                ...
                SqlCommand SqlConnection = new SqlCommand(createtable_sqlstr, mySqlConnection);
                    ...
                    for (int pg = 1; pg <= pageNum; pg++)
                    {
                        ...
                        foreach (Match match in matches)
                        {
                            ...
                            tasklist.Add(Task.Run(() =>
                            {
                                ...
                                SqlCommand SqlConnection_insert = new SqlCommand(insert_sqlstr, mySqlConnection);
                                SqlConnection_insert.ExecuteNonQuery();
                            }));
